...
<div class="form-container">
    <form action="{{ route('watchmakingTerm.create') }}" method="post">
        ...
        <textarea id="explanation" name="explanation" rows="4" pattern="[A-Za-z0-9\s]+" title="Prosím, zadajte platné vysvetlenie, iba písmená, číslice a medzery" required>{{ old('explanation') }}</textarea>
